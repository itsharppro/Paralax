...
using Paralax.Tracing.Jaeger.Tracers;
...
namespace Paralax.Tracing.Jaeger
{
    public static class Extensions
    {
        ...
        public static IParalaxBuilder AddJaeger(this IParalaxBuilder builder, string sectionName = SectionName,
        ...
        public static IParalaxBuilder AddJaeger(this IParalaxBuilder builder,
        ...
        public static IParalaxBuilder AddJaeger(this IParalaxBuilder builder, JaegerOptions options,
            string sectionName = SectionName, Action<IOpenTracingBuilder> openTracingBuilder = null)
        {
            ...
            if (!options.Enabled)
            {
                var defaultTracer = ParalaxDefaultTracer.Create();
