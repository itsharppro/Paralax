...
using Paralax.Auth.Handlers;
using Paralax.Auth.Services;
...
namespace Paralax.Auth
{
    public static class Extensions
    {
        ...
        public static IParalaxBuilder AddJwt(this IParalaxBuilder builder, string sectionName = SectionName,
        ...
        private static IParalaxBuilder AddJwt(this IParalaxBuilder builder, JwtOptions options,
            Action<JwtBearerOptions> optionsFactory = null)
        {
