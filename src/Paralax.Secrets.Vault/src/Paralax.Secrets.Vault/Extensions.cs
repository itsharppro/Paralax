...
using Paralax.Secrets.Vault.Core;
using VaultSharp;
...
namespace Convey.Secrets.Vault
{
    public static class Extensions
    {
        ...
        // UseVault extension method for IHostBuilder
        ...
        // UseVault extension method for IWebHostBuilder
            ...
            string keyValuePath)
        {
            ...
            if (!string.IsNullOrWhiteSpace(kvPath) && options.Kv.Enabled)
            {
                ...
                var json = NetJSON.NetJSON.Serialize(secret);
